	...
	<div>
		...
		<form action="${pageContext.request.contextPath}/seConnecter" method="post">
					...
					<label for="mpCo">Mot de passe :</label>
  					<input type="text" id="mpCo" name="mpCo" value="<c:if test="${!empty cookie.cookieCoMPENITrocenchere.value}">${cookie.cookieCoMPENITrocenchere.value}</c:if>" maxlength="30" required><br>
